...
import WallStreet.ReportGenerator;
...
public class reportController implements Initializable {
    ...
    @FXML
    private ChoiceBox<String> format_selector;
    @FXML
    ...
    @FXML
    private AnchorPane format_pane;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        format_selector.getItems().addAll(format);

    }

    public void generateReport(ActionEvent event){
        String format = format_selector.getValue();
