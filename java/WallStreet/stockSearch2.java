...
// this class is  used in console output without GUI
public class stockSearch2 {
    private PriorityQueue<Stock> stocks;
    Scanner sc = new Scanner(System.in);
    public stockSearch2(PriorityQueue<Stock> stocks) {
        this.stocks = stocks;
    }
    ...
    public static void main(String[] args) {
        Stocklist2 po= new Stocklist2();
        stockSearch2 ss= new stockSearch2(po.fetchStockList());
ss.searchStocks();
    }
}